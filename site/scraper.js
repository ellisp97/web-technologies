...
//initialise table
// db.run('CREATE TABLE productData(prod_id INTEGER PRIMARY KEY AUTOINCREMENT, prod_name TEXT,prod_currency TEXT, prod_price REAL, prod_url TEXT, user_id INTEGER)');// --- INITIAL PRODUCT TABLE HAS BEEN MADE
